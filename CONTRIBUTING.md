...
[Fork this repository](https://github.com/rapid7/windows_error/fork)
...
`ISSUE` is either a [Github issue](https://github.com/rapid7/windows_error/issues) or an issue from some other
...
1. Update `PRERELEASE` to match the `SUMMARY` in the branch name.  If you branched from `master`, and [version.rb](lib/windows_error/version.rb) does not have `PRERELEASE` defined, then adding the following lines after `PATCH`:
```
...
* [Create new Pull Request](https://github.com/rapid7/windows_error/compare/)
